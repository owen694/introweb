...
def grade(a):
    if a<6:
        return "Uh-oh. You might consider learning more about hardware. "
    elif a<9:
...
def main():
    ...
    htmlTop()
    print ' <div id="yeet" style="height: 440px; line-height: 30px;"> <center><p> <span style="font-weight:900; font-size:30px;">Quiz</span></p>'
